...
function cadastrarJogoFavorito(req, res) {
    // Crie uma variável que vá recuperar os valores do arquivo cadastro.html
    var fktipoGame = req.body.fkTipoGame;
    var fkUsuario = req.body.fkUsuario;
    // Faça as validações dos valores
    if (fktipoGame == undefined) {
...
function gravarConfig(req, res) {
    // Crie uma variável que vá recuperar os valores do arquivo cadastro.html
    var fkConfig = req.body.fkConfig;
    var idUsuario = req.body.idUsuario;
    // Faça as validações dos valores
    if (fkConfig == undefined) {
...
function carregarMoba(req, res) {

    usuarioModel.carregarMoba().then(function (resultado) {
        if (resultado.length > 0) {
            res.status(200).json(resultado);
        } else {
            res.status(204).send("Nenhum resultado encontrado!")
...
function carregarComp(req, res) {

    usuarioModel.carregarComp().then(function (resultado) {
        if (resultado.length > 0) {
            res.status(200).json(resultado);
        } else {
            res.status(204).send("Nenhum resultado encontrado!")
